...
app = FastAPI(title='Backstract Generated APIs - coll-4ce43fbcd5ff431293e87d1ac2dc2d08', debug=False,
              docs_url='/objective-vihaan-55e9e658f99111ef92110242ac1200055/docs',
              openapi_url='/objective-vihaan-55e9e658f99111ef92110242ac1200055/openapi.json')
...
app.include_router(
    router,
    prefix='/objective-vihaan-55e9e658f99111ef92110242ac1200055/api',
    tags=['APIs v1']
)
